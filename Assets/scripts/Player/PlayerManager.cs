...
#pragma warning disable 649
    ...
    public class PlayerManager : MonoBehaviourPunCallbacks, IPunObservable
    {
        ...
        {
            if (other.tag == triggeringTag && photonView.IsMine && !checkForShield())
            {
                this.Health -= 0.1f;
                GameObject otherObject = other.transform.parent.gameObject.transform.parent.gameObject;
                obj = otherObject;
                otherObject.GetComponentInChildren<scoreCounter>().updateScore(scoring);
            }
        }
        ...
        public bool checkForShield()
        {
            ...
            {
                if (child.gameObject.name == "ShieldOn(Clone)") return true;
            }
            return false;
        }
